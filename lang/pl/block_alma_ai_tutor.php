...
$string['alma_ai_tutor:addinstance'] = 'Dodaj nowy blok chatbot';
$string['alma_ai_tutor:myaddinstance'] = 'Dodaj nowy blok chatbot do pulpitu nawigacyjnego';
...
$string['alma_ai_tutor:manage'] = 'Zarządzaj ustawieniami chatbot';
...
$string['privacy:metadata:block_alma_ai_tutor_conversations'] = 'Informacje o rozmowach użytkowników z chatbotem';
$string['privacy:metadata:block_alma_ai_tutor_conversations:userid'] = 'ID użytkownika, który utworzył rozmowę';
$string['privacy:metadata:block_alma_ai_tutor_conversations:question'] = 'Pytanie zadane przez użytkownika';
$string['privacy:metadata:block_alma_ai_tutor_conversations:answer'] = 'Odpowiedź udzielona przez chatbota';
$string['privacy:metadata:block_alma_ai_tutor_conversations:timecreated'] = 'Czas utworzenia rozmowy';
$string['privacy:metadata:block_alma_ai_tutor_conversations:courseid'] = 'ID kursu, w którym odbyła się rozmowa';
$string['privacy:metadata:block_alma_ai_tutor_prompts'] = 'Informacje o niestandardowych promptach utworzonych przez użytkowników';
$string['privacy:metadata:block_alma_ai_tutor_prompts:prompt'] = 'Tekst niestandardowego prompta utworzonego przez użytkownika';
$string['privacy:metadata:block_alma_ai_tutor_prompts:userid'] = 'ID użytkownika, który utworzył prompt';
$string['privacy:metadata:block_alma_ai_tutor_prompts:courseid'] = 'ID kursu, w którym został utworzony prompt';
$string['privacy:metadata:block_alma_ai_tutor_prompts:timecreated'] = 'Czas utworzenia prompta';
