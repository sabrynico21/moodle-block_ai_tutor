...
$string['alma_ai_tutor:addinstance'] = '添加新的聊天机器人块';
$string['alma_ai_tutor:myaddinstance'] = '在仪表板中添加新的聊天机器人块';
...
$string['alma_ai_tutor:manage'] = '管理聊天机器人设置';
...
$string['privacy:metadata:block_alma_ai_tutor_conversations'] = '关于用户与聊天机器人对话的信息';
$string['privacy:metadata:block_alma_ai_tutor_conversations:userid'] = '创建对话的用户ID';
$string['privacy:metadata:block_alma_ai_tutor_conversations:question'] = '用户提出的问题';
$string['privacy:metadata:block_alma_ai_tutor_conversations:answer'] = '聊天机器人提供的答案';
$string['privacy:metadata:block_alma_ai_tutor_conversations:timecreated'] = '对话创建的时间';
$string['privacy:metadata:block_alma_ai_tutor_conversations:courseid'] = '对话发生的课程ID';
$string['privacy:metadata:block_alma_ai_tutor_prompts'] = '关于用户创建的自定义提示的信息';
$string['privacy:metadata:block_alma_ai_tutor_prompts:prompt'] = '用户创建的自定义提示文本';
$string['privacy:metadata:block_alma_ai_tutor_prompts:userid'] = '创建提示的用户ID';
$string['privacy:metadata:block_alma_ai_tutor_prompts:courseid'] = '创建提示的课程ID';
$string['privacy:metadata:block_alma_ai_tutor_prompts:timecreated'] = '提示创建的时间';
