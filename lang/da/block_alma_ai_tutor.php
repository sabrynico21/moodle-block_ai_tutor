...
$string['alma_ai_tutor:addinstance'] = 'Tilføj en ny chatbot-blok';
$string['alma_ai_tutor:myaddinstance'] = 'Tilføj en ny chatbot-blok til dashboardet';
...
$string['alma_ai_tutor:manage'] = 'Administrer chatbot-indstillinger';
...
$string['privacy:metadata:block_alma_ai_tutor_conversations'] = 'Information om brugersamtaler med chatbotten';
$string['privacy:metadata:block_alma_ai_tutor_conversations:userid'] = 'ID\'et for brugeren, der oprettede samtalen';
$string['privacy:metadata:block_alma_ai_tutor_conversations:question'] = 'Spørgsmålet stillet af brugeren';
$string['privacy:metadata:block_alma_ai_tutor_conversations:answer'] = 'Svaret givet af chatbotten';
$string['privacy:metadata:block_alma_ai_tutor_conversations:timecreated'] = 'Tidspunktet hvor samtalen blev oprettet';
$string['privacy:metadata:block_alma_ai_tutor_conversations:courseid'] = 'ID\'et for kurset hvor samtalen fandt sted';
$string['privacy:metadata:block_alma_ai_tutor_prompts'] = 'Information om brugerdefinerede prompts oprettet af brugere';
$string['privacy:metadata:block_alma_ai_tutor_prompts:prompt'] = 'Den brugerdefinerede prompt-tekst oprettet af brugeren';
$string['privacy:metadata:block_alma_ai_tutor_prompts:userid'] = 'ID\'et for brugeren, der oprettede prompten';
$string['privacy:metadata:block_alma_ai_tutor_prompts:courseid'] = 'ID\'et for kurset hvor prompten blev oprettet';
$string['privacy:metadata:block_alma_ai_tutor_prompts:timecreated'] = 'Tidspunktet hvor prompten blev oprettet';
