...
$string['privacy:metadata:block_alma_ai_tutor_conversations:sectionid'] = 'The section ID where the conversation took place';
$string['privacy:metadata:block_alma_ai_tutor_conversations:instanceid'] = 'The block instance ID for the conversation';
$string['privacy:metadata:block_alma_ai_tutor_conversations:sessionid'] = 'The conversation session ID';
$string['privacy:metadata:block_alma_ai_tutor_chat_sessions'] = 'Information about grouped chatbot conversation sessions';
$string['privacy:metadata:block_alma_ai_tutor_chat_sessions:userid'] = 'The ID of the user who owns the session';
$string['privacy:metadata:block_alma_ai_tutor_chat_sessions:courseid'] = 'The ID of the course where the session was created';
$string['privacy:metadata:block_alma_ai_tutor_chat_sessions:sectionid'] = 'The section ID associated with the session';
$string['privacy:metadata:block_alma_ai_tutor_chat_sessions:instanceid'] = 'The block instance ID associated with the session';
$string['privacy:metadata:block_alma_ai_tutor_chat_sessions:title'] = 'The generated title of the chat session';
$string['privacy:metadata:block_alma_ai_tutor_chat_sessions:timecreated'] = 'The time when the session was created';
$string['privacy:metadata:block_alma_ai_tutor_chat_sessions:timemodified'] = 'The time of the latest activity in the session';
...
$string['open_teacher_analytics'] = 'Open analytics page';
$string['teacher_analytics_title'] = 'Chatbot usage analytics';
$string['teacher_analytics_no_data'] = 'No student usage data found for this scope.';
$string['teacher_analytics_no_student_sessions'] = 'This student has no chatbot sessions in this scope.';
$string['teacher_analytics_no_messages'] = 'No messages found in this session.';
$string['student'] = 'Student';
$string['sections_used'] = 'Sections used';
$string['total_sessions'] = 'Total sessions';
$string['total_messages'] = 'Total messages';
$string['last_activity'] = 'Last activity';
$string['student_sessions'] = 'Student sessions';
$string['session_title'] = 'Session title';
$string['untitled_session'] = 'Untitled session';
$string['session_transcript'] = 'Session transcript';
$string['student_question'] = 'Student question';
$string['chatbot_answer'] = 'Chatbot answer';
