...
$string['alma_ai_tutor:addinstance'] = 'Ongeza kichaguzi kipya cha chatbot';
$string['alma_ai_tutor:myaddinstance'] = 'Ongeza kichaguzi kipya cha chatbot kwenye Ukurasa wa Mwanzo';
...
$string['alma_ai_tutor:manage'] = 'Bainisha mipangilio ya chatbot';
...
$string['privacy:metadata:block_alma_ai_tutor_conversations'] = 'Taarifa kuhusu mazungumzo ya watumiaji na chatbot';
$string['privacy:metadata:block_alma_ai_tutor_conversations:userid'] = 'Kitambulisho cha mtumiaji aliyeunda mazungumzo';
$string['privacy:metadata:block_alma_ai_tutor_conversations:question'] = 'Swali lililojibiwa na mtumiaji';
$string['privacy:metadata:block_alma_ai_tutor_conversations:answer'] = 'Jibu lililotolewa na chatbot';
$string['privacy:metadata:block_alma_ai_tutor_conversations:timecreated'] = 'Wakati mazungumzo yalipotengenezwa';
$string['privacy:metadata:block_alma_ai_tutor_conversations:courseid'] = 'Kitambulisho cha kozi ambapo mazungumzo yalifanyika';
$string['privacy:metadata:block_alma_ai_tutor_prompts'] = 'Taarifa kuhusu agizo maalum lililotengenezwa na watumiaji';
$string['privacy:metadata:block_alma_ai_tutor_prompts:prompt'] = 'Maandishi ya agizo maalum yaliyotengenezwa na mtumiaji';
$string['privacy:metadata:block_alma_ai_tutor_prompts:userid'] = 'Kitambulisho cha mtumiaji aliyetengeneza agizo';
$string['privacy:metadata:block_alma_ai_tutor_prompts:courseid'] = 'Kitambulisho cha kozi ambapo agizo lilitengenezwa';
$string['privacy:metadata:block_alma_ai_tutor_prompts:timecreated'] = 'Wakati agizo lilipotengenezwa';
