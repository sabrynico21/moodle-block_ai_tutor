...
$string['alma_ai_tutor:addinstance'] = '新しいチャットボットブロックを追加';
$string['alma_ai_tutor:myaddinstance'] = 'ダッシュボードに新しいチャットボットブロックを追加';
...
$string['alma_ai_tutor:manage'] = 'チャットボットの設定を管理';
...
$string['privacy:metadata:block_alma_ai_tutor_conversations'] = 'チャットボットとのユーザー会話に関する情報';
$string['privacy:metadata:block_alma_ai_tutor_conversations:userid'] = '会話を作成したユーザーのID';
$string['privacy:metadata:block_alma_ai_tutor_conversations:question'] = 'ユーザーが質問した内容';
$string['privacy:metadata:block_alma_ai_tutor_conversations:answer'] = 'チャットボットが提供した回答';
$string['privacy:metadata:block_alma_ai_tutor_conversations:timecreated'] = '会話が作成された時刻';
$string['privacy:metadata:block_alma_ai_tutor_conversations:courseid'] = '会話が行われたコースのID';
$string['privacy:metadata:block_alma_ai_tutor_prompts'] = 'ユーザーが作成したカスタムプロンプトに関する情報';
$string['privacy:metadata:block_alma_ai_tutor_prompts:prompt'] = 'ユーザーが作成したカスタムプロンプトテキスト';
$string['privacy:metadata:block_alma_ai_tutor_prompts:userid'] = 'プロンプトを作成したユーザーのID';
$string['privacy:metadata:block_alma_ai_tutor_prompts:courseid'] = 'プロンプトが作成されたコースのID';
$string['privacy:metadata:block_alma_ai_tutor_prompts:timecreated'] = 'プロンプトが作成された時刻';
